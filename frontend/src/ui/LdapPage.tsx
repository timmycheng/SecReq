...
import {
  Alert, Button, Card, Col, Form, Input, InputNumber, Row, Select, Space, Switch, Typography,
  message,
} from 'antd'
...
export default function LdapPage() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      />
      {/* DESIGN: 页面整体居中 */}
      {/* #299: 左右分栏 —— 对接配置在左, 属性映射+登录策略堆右侧, 一屏呈现免滚屏 */}
          ...
          <Col xs={24} lg={10}>
            <Card title="属性映射" style={{ marginBottom: 16 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '0 24px' }}>
                ...
                <Form.Item name="attr_email" label="邮箱属性" style={{ marginBottom: 0 }}>
