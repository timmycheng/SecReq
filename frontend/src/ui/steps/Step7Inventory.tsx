/* 第 6 步「组件与基础设施」(#259): 评估内就地确认系统清单。
   单一事实源仍在系统清单(#194): 本步内嵌系统清单卡, 进入即默认带出系统已存版本
   ("每次评估从系统复制信息"的默认功能), 修改保存写穿系统清单、下一轮评估自动带出
  ...
  if (!systemId) {
    return (
      <Alert
        ...
        message="本评估未归属系统"
        description="组件与基础设施挂在系统清单维护, 请先回到第 1 步选择所属系统。"
      />
    )
  }
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      <Alert
        ...
        description={(
          <span>
            组件与基础设施是<b>系统级</b>信息集合: 本步展示系统清单当前版本, 修改保存后同步更新系统清单,
